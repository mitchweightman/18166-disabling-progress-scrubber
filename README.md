...
# 18166-disabling-progress-scrubber
For more information about this sample see: https://support.brightcove.com/brightcove-player-sample-disabling-progress-scrubber.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The JavaScript for the plugin. An example, actual filename could be <strong>disableScrubber.js</strong>.</td>
    </tr>
    <tr>
      <td>plugin/pluginName.css</td>
      <td>The CSS for the plugin. An example, actual filename could be <strong>disableScrubber.css</strong>.</td>
    </tr>
  </tbody>
</table>
